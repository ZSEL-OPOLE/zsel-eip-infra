# ═══════════════════════════════════════════════════════════════
# ACCESS-SWITCH-03 - Complete Configuration
# Project: BCU ZSE Opole - Network Infrastructure
# Device: MikroTik CRS354-48G-4S+2Q+RM
# Role: Access Switch (Mac Pro 07-09 - K3s Workers 04-06)
# Management IP: 192.168.255.13/28 (VLAN 600)
# Date: 2025-11-27
# ═══════════════════════════════════════════════════════════════
...
/interface bridge port add bridge=bridge interface=ether1 pvid=110 comment="Mac Pro 07 - k3s-worker-04"
/interface bridge port add bridge=bridge interface=ether2 pvid=110 comment="Mac Pro 08 - k3s-worker-05"
/interface bridge port add bridge=bridge interface=ether3 pvid=110 comment="Mac Pro 09 - k3s-worker-06"
...
/snmp set enabled=yes contact="admin@zsel.opole.pl" location="BCU Building - ACCESS-03"
...
# ═══════════════════════════════════════════════════════════════
# END - ACCESS-SWITCH-03
# Connected: Mac Pro 07-09 (K3s Workers 04-06)
# ═══════════════════════════════════════════════════════════════
