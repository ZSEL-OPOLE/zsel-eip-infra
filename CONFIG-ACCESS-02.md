# 🎯 ACCESS-SWITCH-02 - Pełna Konfiguracja

**Model:** MikroTik CRS354-48G-4S+2Q+RM  
**Rola:** Access switch (Mac Pro 04-06 connectivity)  
**Lokalizacja:** Rack z Mac Pro 04-06
...
```
ether1 → Mac Pro 04 (k3s-worker-01) - 192.168.10.14
ether2 → Mac Pro 05 (k3s-worker-02) - 192.168.10.15
ether3 → Mac Pro 06 (k3s-worker-03) - 192.168.10.16
...
**⚠️ IMPORTANT:** Configure this switch AFTER ACCESS-01!

**Physical Connection:**
```
[Laptop] ─── ether48 ─── [ACCESS-02]
...
/interface bridge port add bridge=bridge interface=ether1 pvid=110 comment="Mac Pro 04 - worker-01"
/interface bridge port add bridge=bridge interface=ether2 pvid=110 comment="Mac Pro 05 - worker-02"
/interface bridge port add bridge=bridge interface=ether3 pvid=110 comment="Mac Pro 06 - worker-03"
...
/snmp set enabled=yes contact="admin@zsel.opole.pl" location="BCU Building - Rack with Mac Pro 04-06"
...
```routeros
/system backup save name=access-switch-02-initial
/export file=access-switch-02-config
```
...
| **Management IP** | 192.168.255.12/28 |
| **Gateway** | 192.168.255.1 |
| **Connected Devices** | Mac Pro 04-06 (K3s workers) |
...
4. ✅ Connect to CORE: sfp-sfpplus1 → CORE sfp-sfpplus2
5. ⏸️ DO NOT connect Mac Pro yet
6. ✅ Proceed to ACCESS-03 configuration
